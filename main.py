...
from pdf_merger.observability import (
    get_crash_reporter,
...
def show_error_dialog(title: str, message: str):
    ...
    try:
        ...
        # Clean up
        root.destroy()
    # Intentional: see ARCHITECTURE.md "Intentional broad catches". Reason: last-resort when messagebox fails.
...
def main():
    ...
    if license_status == LicenseStatus.VALID:
        ...
        try:
            ...
            # Best-effort metrics export on shutdown; never block or raise
            if config.metrics_enabled:
                try:

...
class TestValidatePath:
    ...
    @patch("pdf_merger.utils.path_utils.logger")
    def test_validate_path_long_path_windows_disabled(
        self, mock_logger, mock_enable, mock_is_long, mock_system, tmp_path
    ):
    ...
    @patch("pdf_merger.utils.path_utils.is_long_path")
    @patch("pdf_merger.utils.path_utils.enable_long_paths_windows")
    def test_validate_path_long_path_windows_enabled(
        self, mock_enable, mock_is_long, mock_system, tmp_path
    ):

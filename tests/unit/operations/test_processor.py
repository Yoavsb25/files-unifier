...
class TestProcessRowWithModels:
    ...
    @patch('pdf_merger.processor.merge_pdfs')
    @patch('pdf_merger.processor._convert_excel_files_to_pdfs')
    @patch('pdf_merger.processor.find_source_file')
    @patch('pdf_merger.processor.get_metrics_collector')
    def test_process_row_with_models_success(self, mock_metrics, mock_find, mock_convert, mock_merge, tmp_path):
        ...
        from pdf_merger.processor import process_row_with_models
...
class TestProcessJob:
    ...
    @patch('pdf_merger.processor.process_row_with_models')
    @patch('pdf_merger.processor.get_metrics_collector')
    def test_process_job_success(self, mock_metrics, mock_process_row, tmp_path):
        ...
        from pdf_merger.processor import process_job
...
class TestConvertExcelFilesToPdfs:
    ...
    @patch('pdf_merger.processor.convert_excel_to_pdf')
    @patch('pdf_merger.processor.tempfile.NamedTemporaryFile')
    def test_convert_excel_files_to_pdfs_success(self, mock_tempfile, mock_convert, tmp_path):
        ...
        from pdf_merger.processor import _convert_excel_files_to_pdfs
...
class TestCleanupTempFiles:
    ...
    def test_cleanup_temp_files_success(self, tmp_path):
        ...
        from pdf_merger.processor import _cleanup_temp_files

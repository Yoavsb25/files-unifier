...
from pdf_merger.operations.pdf_merger import _get_pdf_libraries, find_source_file, merge_pdfs
...
class TestMergePdfs:
    ...
    def test_merge_pdfs_success(self, mock_get_libraries, tmp_path):
        ...
        pdf_paths = [tmp_path / "file1.pdf", tmp_path / "file2.pdf"]
    ...
    @patch("pdf_merger.operations.pdf_merger.logger")
    def test_merge_pdfs_auto_streaming_enabled(
        self, mock_logger, mock_should_stream, mock_stream_merge, tmp_path
    ):
    ...
    def test_merge_pdfs_streaming_import_error(self, mock_logger, tmp_path):
        ...
        with patch(
            "pdf_merger.operations.streaming_pdf_merger.merge_pdfs_streaming",
            side_effect=ImportError("Streaming not available"),
        ):
    ...
    def test_merge_pdfs_auto_streaming_import_error(self, mock_logger, tmp_path):
        ...
        with patch(
            "pdf_merger.operations.streaming_pdf_merger.should_use_streaming",
...
class TestGetPdfLibraries:
    ...
    def test_get_pdf_libraries_imports_pypdf(self):
        ...
        try:
            ...
            with patch("pypdf.PdfWriter", MagicMock()), patch("pypdf.PdfReader", MagicMock()):

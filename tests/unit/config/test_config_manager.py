...
class TestAppConfig:
    ...
    def test_app_config_to_dict(self):
        ...
        config = AppConfig(
            input_file="/path/to/input.csv", pdf_dir="/path/to/pdfs", output_dir="/path/to/output"
        )
    ...
    def test_app_config_from_dict_defaults(self):
        ...
        data = {"input_file": "/path/to/input.csv"}
    ...
    def test_app_config_merge(self):
        ...
        config1 = AppConfig(
            input_file="/path1/input.csv", pdf_dir="/path1/pdfs", required_column="column1"
        )
        config2 = AppConfig(input_file="/path2/input.csv", output_dir="/path2/output")
    ...
    def test_app_config_merge_none_values(self):
        ...
        config1 = AppConfig(input_file="/path1/input.csv", pdf_dir="/path1/pdfs")
    ...
    def test_app_config_merge_boolean_fields(self):
        ...
        config2 = AppConfig(metrics_enabled=False, telemetry_enabled=True)
...
class TestLoadConfig:
    ...
    def test_load_config_success(
        self, mock_user_config, mock_project_preset, mock_env_config, tmp_path
    ):
    ...
    @patch("pdf_merger.config.config_manager.load_project_preset")
    @patch("pdf_merger.config.config_manager.load_user_config")
    def test_load_config_precedence_env_overrides_all(
        self, mock_user_config, mock_project_preset, mock_env_config, tmp_path
    ):
    ...
    @patch("pdf_merger.config.config_manager.load_project_preset")
    @patch("pdf_merger.config.config_manager.load_user_config")
    def test_load_config_precedence_user_overrides_project(
        self, mock_user_config, mock_project_preset, mock_env_config, tmp_path
    ):
    ...
    @patch("pdf_merger.config.config_manager.load_project_preset")
    @patch("pdf_merger.config.config_manager.load_user_config")
    def test_load_config_with_start_path(
        self, mock_user_config, mock_project_preset, mock_env_config, tmp_path
    ):
...
class TestLoadUserConfig:
    ...
    def test_load_user_config_not_found(self, tmp_path):
        ...
        with patch(
            "pdf_merger.config.config_manager.get_config_path",
    ...
    def test_load_user_config_success(self, tmp_path):
        ...
        config_file = tmp_path / "config.json"
        config_data = {"input_file": str(input_file), "pdf_dir": str(pdf_dir)}
        config_file.write_text(json.dumps(config_data))
...
class TestLoadEnvConfig:
    ...
    def test_load_env_config_partial_vars(self, tmp_path):
        ...
        from pdf_merger.config.config_manager import ENV_INPUT_FILE

...
class TestConfigSchema:
    ...
    def test_validate_column_none(self):
        ...
        assert result == Constants.GOLDFARB_SERIAL_NUMBER_COLUMN_NAME
    ...
    def test_validate_config_minimal(self):
        ...
        assert result['required_column'] == Constants.GOLDFARB_SERIAL_NUMBER_COLUMN_NAME
    ...
    def test_validate_config_invalid_column(self, tmp_path):
        ...
        # Invalid column should default to Constants.GOLDFARB_SERIAL_NUMBER_COLUMN_NAME
        assert result['required_column'] == Constants.GOLDFARB_SERIAL_NUMBER_COLUMN_NAME

...
from pdf_merger.utils.serial_number_parser import (
...
class TestDeduplicateSerialNumbers:
    ...
    def test_deduplicate_no_preserve_order(self):
        ...
        result = deduplicate_serial_numbers(
            ["GRNW_000103851", "GRNW_000103852", "GRNW_000103851"], preserve_order=False
        )
        assert len(result) == 2
    ...
    def test_deduplicate_no_duplicates(self):
        ...
        result = deduplicate_serial_numbers(
            ["GRNW_000103851", "GRNW_000103852", "GRNW_000103853"], preserve_order=True
        )
        assert result == ["GRNW_000103851", "GRNW_000103852", "GRNW_000103853"]
    ...
    def test_deduplicate_filters_none(self):
        ...
        result = deduplicate_serial_numbers(
            ["GRNW_000103851", None, "GRNW_000103852", None], preserve_order=True
        )
        assert result == ["GRNW_000103851", "GRNW_000103852"]

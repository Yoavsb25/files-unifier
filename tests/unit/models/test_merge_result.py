...
from pdf_merger.models.merge_result import MergeResult, RowResult, RowStatus
...
class TestRowResult:
    ...
    def test_row_result_success(self):
        ...
        result = RowResult(row_index=0, status=RowStatus.SUCCESS, output_file=output_file)
    ...
    def test_row_result_failed(self):
        ...
        result = RowResult(row_index=1, status=RowStatus.FAILED, error_message="File not found")
    ...
    def test_row_result_skipped(self):
        ...
        result = RowResult(row_index=2, status=RowStatus.SKIPPED, error_message="No serial numbers")
    ...
    def test_row_result_with_processing_time(self):
        ...
        result = RowResult(row_index=0, status=RowStatus.SUCCESS, processing_time=1.5)
    ...
    def test_row_result_str_without_output_file(self):
        ...
        result = RowResult(row_index=1, status=RowStatus.FAILED)
...
class TestMergeResult:
    ...
    def test_merge_result_basic(self):
        ...
        result = MergeResult(total_rows=10, successful_merges=8)
    ...
    def test_merge_result_with_failed_rows(self):
        ...
        result = MergeResult(total_rows=10, successful_merges=7, failed_rows=[2, 5])
    ...
    def test_merge_result_with_skipped_rows(self):
        ...
        result = MergeResult(total_rows=10, successful_merges=8, skipped_rows=[1, 3])
    ...
    def test_merge_result_with_job_id(self):
        ...
        result = MergeResult(total_rows=10, successful_merges=8, job_id="job-123")
    ...
    def test_add_row_result_success(self):
        ...
        row_result = RowResult(
            row_index=0, status=RowStatus.SUCCESS, output_file=Path("/tmp/test.pdf")
        )
    ...
    def test_add_row_result_failed(self):
        ...
        result = MergeResult(total_rows=1, successful_merges=0)
        row_result = RowResult(row_index=0, status=RowStatus.FAILED, error_message="Error")
    ...
    def test_add_row_result_skipped(self):
        ...
        result = MergeResult(total_rows=1, successful_merges=0)
        row_result = RowResult(row_index=0, status=RowStatus.SKIPPED)
    ...
    def test_merge_result_str(self):
        ...
        result = MergeResult(
            total_rows=10, successful_merges=8, failed_rows=[2, 5], skipped_rows=[1]
        )
    ...
    def test_merge_result_with_processing_time(self):
        ...
        result = MergeResult(total_rows=10, successful_merges=8, total_processing_time=5.5)

...
from pdf_merger.licensing.license_manager import LicenseManager, LicenseStatus
...
class TestLicense:
    ...
    def test_license_from_dict_defaults(self):
        ...
        data = {"company": "Test Company", "expires": "2027-12-31"}
    ...
    def test_license_is_expired_future(self):
        ...
        license = License(company="Test", expires=future_date, allowed_machines=1, version="1.0.0")
    ...
    def test_license_is_expired_past(self):
        ...
        license = License(company="Test", expires=past_date, allowed_machines=1, version="1.0.0")
    ...
    def test_license_is_expired_invalid_format(self):
        ...
        license = License(
            company="Test", expires="invalid-date", allowed_machines=1, version="1.0.0"
        )
    ...
    def test_license_is_expired_with_tolerance(self):
        ...
        license = License(company="Test", expires=yesterday, allowed_machines=1, version="1.0.0")
        ...
        license_today = License(company="Test", expires=today, allowed_machines=1, version="1.0.0")
    ...
    def test_license_to_json_string(self):
        ...
        license = License(
            company="Test Company", expires="2027-12-31", allowed_machines=5, version="1.0.0"
        )
    ...
    def test_license_save_to_file_creates_directory(self, tmp_path):
        ...
        license = License(company="Test", expires="2027-12-31", allowed_machines=1, version="1.0.0")
...
class TestLicenseSigner:
    ...
    def test_get_embedded_public_key_licensing_dir(self, tmp_path):
        ...
        with patch("pdf_merger.licensing.license_signer.Path") as mock_path:
            ...
            with patch(
                "pdf_merger.licensing.license_signer.__file__",
                str(licensing_dir / "license_signer.py"),
            ):
...
class TestLicenseManager:
    ...
    def test_get_license_path_app_directory(self, tmp_path):
        ...
        with patch(
            "pdf_merger.licensing.license_manager.__file__", str(app_dir / "license_manager.py")
        ):
    ...
    def test_validate_license_valid(self):
        ...
        future_date = (datetime.now() + timedelta(days=365)).strftime("%Y-%m-%d")
        license = License(
            company="Test Company", expires=future_date, allowed_machines=5, version="1.0.0"
        )
        ...
        with patch(
            "pdf_merger.licensing.license_manager.get_embedded_public_key", return_value=public_key
        ):
    ...
    def test_validate_license_expired(self):
        ...
        past_date = (datetime.now() - timedelta(days=1)).strftime("%Y-%m-%d")
        license = License(
            company="Test Company", expires=past_date, allowed_machines=5, version="1.0.0"
        )
    ...
    def test_get_license_status(self):
        ...
        with patch.object(manager, "load_license", return_value=license):
            with patch(
                "pdf_merger.licensing.license_manager.get_embedded_public_key",
    ...
    def test_get_license_error_message(self):
        ...
        messages = {
            ...
            LicenseStatus.INVALID_SIGNATURE: manager.get_license_error_message(
    ...
    def test_get_expiry_warning_message_expired(self):
        ...
        # Mock the methods
        with (
            patch.object(license, "get_expiry_warning_level", return_value=WarningLevel.EXPIRED),
    ...
    def test_get_expiry_warning_message_warning(self):
        ...
        with (
            patch.object(license, "get_expiry_warning_level", return_value=WarningLevel.WARNING),
    ...
    def test_get_expiry_warning_message_info(self):
        ...
        with (
            patch.object(license, "get_expiry_warning_level", return_value=WarningLevel.INFO),
    ...
    def test_get_expiry_warning_message_loads_license(self):
        ...
        with (
            patch.object(manager, "load_license", return_value=license),
            patch.object(license, "get_expiry_warning_level", return_value=WarningLevel.CRITICAL),
            patch.object(license, "days_until_expiry", return_value=5),
        ):
            message = manager.get_expiry_warning_message()
